! function(e, t) {
    ...
    if (o) { console.warn("将根据已有的meta标签来设置缩放比例");
        ...
        p && (s = parseFloat(p[1]), m = parseInt(1 / s)) } else if (l) {
